      ...
      <main className="flex-1 px-4 pb-24 space-y-6">
        ...
        <section>
          ...
          {groupPlaylists.length === 0 ? (
            <p className="text-sm text-muted-foreground py-4 text-center">아직 플레이리스트가 없어요</p>
          ) : (
            <div className="grid gap-3">
              {groupPlaylists.map(({ Playlist: playlist }) => (
                <Card key={playlist.id} size="sm" className="hover:ring-foreground/20 transition-shadow">
                  <CardHeader>
